...
<xsl:stylesheet version="1.0" 
  ...
  exclude-result-prefixes="l2v2 l2v3 l2v4 l2v5 xhtml">
  ...
  <xsl:template match="l2v4:*">
    <xsl:element name="{local-name(.)}" namespace="http://www.sbml.org/sbml/level2/version1">
      <xsl:apply-templates select="@*|node()"/>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template match="/l2v4:sbml">
    <xsl:element name="sbml" namespace="http://www.sbml.org/sbml/level2/version1">
  ...
  <xsl:template match="l2v4:model">
    <xsl:element name="model" namespace="http://www.sbml.org/sbml/level2/version1">

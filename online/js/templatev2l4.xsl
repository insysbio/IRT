...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="l2v4:*">
    <xsl:element name="{local-name(.)}" namespace="http://www.sbml.org/sbml/level2/version4">
      <xsl:apply-templates select="@*|node()"/>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template match="/l2v4:sbml">
    <xsl:element name="sbml" namespace="http://www.sbml.org/sbml/level2/version4">
  ...
  <xsl:template match="l2v4:model">
    <xsl:element name="model" namespace="http://www.sbml.org/sbml/level2/version4">

...
2017-01-01 The updated [IRT demo online](online) is available
...
2016-09-01 Today is the offical release of IRT 1.0! The demo package has been sended to all subscribers of the project. The full functionality version will be available based on commercial license. Contact IRT team.

2016-07-01 This site is available on http://irt.insysbio.ru.

2016-06-29 The release date of IRT was postponed until 2016-09-01 12:00.
...
The database is distributed under two revisions: (1) demo version is available [online](online) for free under [CC by-nd licence](https://creativecommons.org/licenses/by-nd/4.0/legalcode). (2) the full version is can be obtained under commercial license after request to irt@insysbio.ru 
